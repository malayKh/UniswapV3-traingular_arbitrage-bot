...
def calc_triangular_arb_surface_rate(t_pair, min_rate):
    ...
    for direction in direction_list:
        ...
        c_quote = t_pair["cQuote"]
         ...
         #Set token addresses
        a_token_0_id = t_pair["aToken0Id"]
        a_token_1_id = t_pair["aToken1Id"]
        b_token_0_id = t_pair["bToken0Id"]
        b_token_1_id = t_pair["bToken1Id"]
        c_token_0_id = t_pair["cToken0Id"]
        c_token_1_id = t_pair["cToken1Id"]
        ...
        a_token_0_decimals = t_pair["aToken0Decimals"]
        a_token_1_decimals = t_pair["aToken1Decimals"]
        ...
        # Set address info
        a_fee = t_pair["aFeeTier"]
        b_fee = t_pair["bFeeTier"]
        c_fee = t_pair["cFeeTier"]
        ...
        if direction == "forward":
            ...
            token_1_id = a_token_0_id
            token_1_decimals = a_token_0_decimals
        ...
        if direction == "reverse":
            ...
            token_1_id = a_token_1_id
            token_1_decimals = a_token_1_decimals
        ...
        if profit_loss_perc >= min_surface_rate:
            ...
            surface_dict = {
                ...
                "token2Id": token_2_id,
                "token3Id": token_3_id,
                "token1Decimals": token_1_decimals
            }
            return surface_dict
